...
-   gccrs: replace unreachable with sorry<sub>at</sub>
    [PR4391](https://github.com/rust-gcc/gccrs/pull/4391)
-   util/attributes: handle \#\[export<sub>name</sub>\] on static items
    [PR4390](https://github.com/rust-gcc/gccrs/pull/4390)
-   util/attributes: error on malformed \#\[export<sub>name</sub>\]
    input [PR4389](https://github.com/rust-gcc/gccrs/pull/4389)
-   Handle \`export<sub>name</sub>\` attribute on functions
...
-   ICE in get<sub>dereferencedexpr</sub>, at rust/ast/rust-expr.h:435
    [PR4362](https://github.com/rust-gcc/gccrs/pull/4362)
-   gccrs: Fix ICE in insert<sub>associatedtraitimpl</sub> due to
...
-   util/attributes: error on malformed \#\[link<sub>section</sub>\]
    input [PR4357](https://github.com/rust-gcc/gccrs/pull/4357)
-   util/attributes: Check that \#\[target<sub>feature</sub>\] is only
    used on unsafe …
...
-   util/attributes: error on malformed \#\[no<sub>mangle</sub>\] input
    [PR4354](https://github.com/rust-gcc/gccrs/pull/4354)
-   util/attributes: error on malformed \#\[link<sub>name</sub>\] input
