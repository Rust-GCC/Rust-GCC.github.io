...
[Lenny Chiadmi Delage](https://github.com/Villosse) and [Lucas Ly
Ba](https://github.com/lucasly-ba), who have greatly improved various
...
-   Sync with upstream (2026-01-03):
    ...
    [PR4351](https://github.com/rust-gcc/gccrs/pull/4351)
...
-   nr: Add better error to unresolved attribute macro
    [PR4345](https://github.com/rust-gcc/gccrs/pull/4345)
-   Sync with upstream (2025-12-21):
    c65fdb6b03d9146ee9a1ffcfcbc689b004b2b463
    [PR4335](https://github.com/rust-gcc/gccrs/pull/4335)
-   Fix: \#!\[cfg<sub>attr</sub>(…, feature)\]\` not respected
    [PR4334](https://github.com/rust-gcc/gccrs/pull/4334)
-   Make some general improvements
    [PR4332](https://github.com/rust-gcc/gccrs/pull/4332)
-   gccrs: refactor string methods in HIR
    [PR4331](https://github.com/rust-gcc/gccrs/pull/4331)
-   Sync with upstream (2025-12-10):
    203d4dd09ba83121e447ce93ba98175b68d955f6
    [PR4328](https://github.com/rust-gcc/gccrs/pull/4328)
-   Check for deprecated attributes
    [PR4327](https://github.com/rust-gcc/gccrs/pull/4327)
-   Follow up to \#3212
    [PR4326](https://github.com/rust-gcc/gccrs/pull/4326)
-   Use the path location for MetaItemPathExpr
    [PR4324](https://github.com/rust-gcc/gccrs/pull/4324)
-   Split the parser implementation into multiple files
    [PR4322](https://github.com/rust-gcc/gccrs/pull/4322)
-   Sync with upstream (2025-12-01):
    4d1bfc66f84de6b37b175a191cba8cdd552c4383
    [PR4320](https://github.com/rust-gcc/gccrs/pull/4320)
...
-   Remove match arm pattern vector to single pattern
    [PR4297](https://github.com/rust-gcc/gccrs/pull/4297)
-   Implement unused mut lint
    [PR4290](https://github.com/rust-gcc/gccrs/pull/4290)
-   Use tl::expected in the parser to avoid error state
    [PR4288](https://github.com/rust-gcc/gccrs/pull/4288)
-   Implement unused assignments lints on HIR
    [PR4285](https://github.com/rust-gcc/gccrs/pull/4285)
-   Implement unused variable checker on HIR
    [PR4283](https://github.com/rust-gcc/gccrs/pull/4283)
-   gccrs:fix ICE with continue/break/return in while condition
    [PR4270](https://github.com/rust-gcc/gccrs/pull/4270)
-   gccrs: fix parser error on parenthesised types
    [PR4214](https://github.com/rust-gcc/gccrs/pull/4214)

### Contributors this month

-   [Harishankar](https://github.com/Harishankar14) (new contributor!)
-   [Ashwani Kumar Kamal](https://github.com/sneaky-potato) (new
    contributor!)
