---
layout: post
title: "September 2025 Monthly report"
...
Most of the time this month was dedicated to preparing and attending
...
another project for Embecosm, thus reducing the time spent on `gccrs`
this month.

Oxidize was a nice experience and a good way to meet with some people
...
the GCC static analyzers on unsafe Rust code.

Kangrejos was a great way for Pierre-Emmanuel to meet with a lot of
...
sticking with a GCC toolchain for compiling the kernel.

In Porto for Cauldron, a lot of GNU folks were interested in the
frontend's experimental status and the projects' roadmap. There were
comments about removing the dependency on `cargo` and `rustc`, which we
are currently working towards with our goal of getting the standard
library to compile under `gccrs`.

On that point, the entirety of `core` was added as a testcase to our
...
associated with built-in types, such as `i8::MAX`.

After communicating with the GCC release managers, we have also worked
...
instead of seeing them in batches every week when we upstream them.

### Community call

We will have our next monthly community call on the 15th of October at
...
-   ci: yet another fix for the conditionnal steps
    [PR4197](https://github.com/rust-gcc/gccrs/pull/4197)
-   ci: fix step condition
    [PR4196](https://github.com/rust-gcc/gccrs/pull/4196)
-   Add doc attribute checking on traits
    [PR4195](https://github.com/rust-gcc/gccrs/pull/4195)
-   Fix malformed path segfault in attributes
    [PR4194](https://github.com/rust-gcc/gccrs/pull/4194)
-   ci: fix early exit
    [PR4193](https://github.com/rust-gcc/gccrs/pull/4193)
-   Add support for lowering rest patterns present in struct patterns to
    HIR. [PR4192](https://github.com/rust-gcc/gccrs/pull/4192)
-   ci: handle empty commit list
    [PR4191](https://github.com/rust-gcc/gccrs/pull/4191)
-   ci: adjust again the workflow for sending emails
    [PR4190](https://github.com/rust-gcc/gccrs/pull/4190)
-   ci: don't do cover letter, don't group by PR
    [PR4189](https://github.com/rust-gcc/gccrs/pull/4189)
-   ci: new workflow for sending emails after merging a PR
    [PR4184](https://github.com/rust-gcc/gccrs/pull/4184)
-   gccrs: Fix ICE where we expect a num enum variant
    [PR4183](https://github.com/rust-gcc/gccrs/pull/4183)
-   gccrs: Add error diag for self params on plain functions
    [PR4182](https://github.com/rust-gcc/gccrs/pull/4182)
-   gccrs: Fix ICE on copied array expressions
    [PR4181](https://github.com/rust-gcc/gccrs/pull/4181)
-   gccrs: Remove old hack from resolve operator overload
    [PR4180](https://github.com/rust-gcc/gccrs/pull/4180)
-   gccrs: fnptr types can hold onto generic params so it needs to
    handle substs [PR4179](https://github.com/rust-gcc/gccrs/pull/4179)
-   Metavar segfault
    [PR4178](https://github.com/rust-gcc/gccrs/pull/4178)
-   gccrs: Fix ICE for invalid const capacity expression handling
    [PR4177](https://github.com/rust-gcc/gccrs/pull/4177)
-   Test \`libcore\`
    [PR4176](https://github.com/rust-gcc/gccrs/pull/4176)
-   Import \`stdarch 1.49.0\`
    [PR4175](https://github.com/rust-gcc/gccrs/pull/4175)
-   Improve \`FFIOpt\`
    [PR4174](https://github.com/rust-gcc/gccrs/pull/4174)
-   gccrs: Fix ICE handling division by zero in const eval
    [PR4172](https://github.com/rust-gcc/gccrs/pull/4172)
-   Remove \`AST::TraitItemConst\`
    [PR4170](https://github.com/rust-gcc/gccrs/pull/4170)
-   Protect from errors in alternate pattern parsing
    [PR4169](https://github.com/rust-gcc/gccrs/pull/4169)
-   gccrs: Fix ICE with invalid const expression
    [PR4150](https://github.com/rust-gcc/gccrs/pull/4150)
-   tests: added extra parens compile test
    [PR4137](https://github.com/rust-gcc/gccrs/pull/4137)
-   Sync with upstream (2025-09-08):
    4eb12ddd32d53ef55c2bd9bb03db057f096fff8f
    [PR4136](https://github.com/rust-gcc/gccrs/pull/4136)
-   Implement \`TokenCollector::visit(AST::FormatArgs&)\`
    [PR4135](https://github.com/rust-gcc/gccrs/pull/4135)
-   gccrs: track abi and unsafety on fnptrs for proper type checking
    [PR4132](https://github.com/rust-gcc/gccrs/pull/4132)
-   gccrs: Revert "nr1.0: Remove support in expansion phase"
    [PR4130](https://github.com/rust-gcc/gccrs/pull/4130)
-   gccrs: Revert "gccrs: Remove the template parameter
    [PR4129](https://github.com/rust-gcc/gccrs/pull/4129)
-   gccrs: get rid of more clones in unify path
    [PR4128](https://github.com/rust-gcc/gccrs/pull/4128)
-   gccrs: remove docker github workflow
    [PR4127](https://github.com/rust-gcc/gccrs/pull/4127)
-   gccrs: Remove the template parameter so clang format stops barfing
    this [PR4126](https://github.com/rust-gcc/gccrs/pull/4126)
-   Add test to confirm Rust-GCC/gccrs#3922 fix
    [PR4125](https://github.com/rust-gcc/gccrs/pull/4125)
-   Add test to confirm Rust-GCC/gccrs#3924 fix
    [PR4124](https://github.com/rust-gcc/gccrs/pull/4124)
-   nr1.0: Remove \`EarlyNameResolver\`
    [PR4123](https://github.com/rust-gcc/gccrs/pull/4123)
-   ci: Bump commit to merge in arm64 ci
    [PR4121](https://github.com/rust-gcc/gccrs/pull/4121)
...
-   Create subdirectory \`checks/errors/feature\`
    [PR4107](https://github.com/rust-gcc/gccrs/pull/4107)
-   Implement compilation support for rest patterns in tuple struct
    patterns [PR4102](https://github.com/rust-gcc/gccrs/pull/4102)
-   Improve ExpandVisitor's completeness
    [PR4099](https://github.com/rust-gcc/gccrs/pull/4099)
-   Vendor \`libcore 1.49\`
    [PR4060](https://github.com/rust-gcc/gccrs/pull/4060)
-   Handle \`link<sub>name</sub>\` attribute
    [PR4031](https://github.com/rust-gcc/gccrs/pull/4031)

### Contributors this month

-   [elle](https://github.com/0xllx0) (new contributor!)
-   [Magnus](https://github.com/Magnus-Mage) (new contributor!)
